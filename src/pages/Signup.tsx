    ...
    <div className="flex items-center justify-center mt-20">
      <div className="bg-white rounded-xl shadow-lg p-10 w-full max-w-md">
		...
		s-4-1.794-4-4C20,21.794,21.794,20,24,20z"
          ...
          <button
            type="submit"
            className="w-full bg-lime-400 text-gray-900 font-semibold py-2 rounded-lg hover:bg-lime-300 transition cursor-pointer disabled:opacity-60 flex items-center justify-center"
            disabled={loading}
          >
            {loading ? (
