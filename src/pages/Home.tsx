...
const a = [
  {
    ...
    alt: "Blog",
    label: "Concise knowledge blogs",
  },
  {
    img: "/src/assets/motivation.png",
    alt: "Motivation",
    label: "Step-by-step lab guides",
  },
  {
    img: "/src/assets/tips.png",
    alt: "Tips",
    label: "Tips & common pitfalls",
  },
  {
    ...
    <>
      ...
      <main className="grid grid-cols-12 items-center px-4 md:px-12 pt-10 md:pt-16 min-h-[calc(100vh-120px)] ml-0 md:ml-3 gap-y-8">
        <div className="col-span-12 md:col-span-7">
          ...
          <p className="text-base md:text-lg font-normal mb-8 text-gray-300">
            The site offers cybersecurity knowledge from basic to advanced with
            interactive lessons, hands-on labs, and a supportive community,
      ...
      <section className="py-10 md:py-14 md:pb-30 px-2 md:px-4 text-center">
        <h3 className="text-2xl md:text-4xl font-semibold text-white mb-4">
          From Zero to Hero: Real-World Cybersecurity Labs for Everyone
        </h3>
        ...
        <p className="text-gray-300 text-base md:text-lg max-w-5xl mx-auto mb-10">
          Master cybersecurity with hands-on labs, structured pathways, and
          real-world scenarios. Our platform provides affordable, engaging, and
          on-demand training for beginners and professionals alike.
        </p>
        ...
        <div className="col-span-12 md:col-span-8">
          ...
          <div className="ml-0 md:ml-3">
            <p className="mb-4 text-base md:text-lg mt-8">
              Labverse is a hands-on cybersecurity learning platform built by
            ...
            <ul className="list-disc ml-6 md:ml-10 space-y-2 text-base md:text-lg">
              <li>
                Beginner-to-advanced knowledge with clear Vietnamese
                explanations
              </li>
              <li>
                Simple yet practical labs compatible with standard hardware
              </li>
              <li>Support community for collaborative learning</li>
            </ul>
          </div>
        </div>
